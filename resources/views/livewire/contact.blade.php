<section class="pt-24 pb-16 px-4 lg:px-20">
    <div class="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12">
        ...
        <!-- Contact Info -->
        <div class="space-y-6">
            <div class="relative bg-gradient-to-br from-indigo-600 to-indigo-400 text-white rounded-xl px-6 py-5 overflow-hidden">
                {{-- line decoration --}}
                <span class="w-full h-8 bg-gradient-to-l from-white/15 to-75% to-white/0 absolute top-0 -right-72 -rotate-45"></span>
                <span class="w-full h-8 bg-gradient-to-r from-white/10 to-75% to-white/0 absolute top-0 -right-60 -rotate-45"></span>
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-white/80">Cirebon, West Java, <br /><strong class="text-white">Indonesia</strong>
                        </p>
                    </div>
                </div>
            </div>
