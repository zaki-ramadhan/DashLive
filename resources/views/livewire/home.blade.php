<section class="pt-8 lg:pt-32 bg-[url('https://pagedone.io/asset/uploads/1691055810.png')] bg-center bg-cover">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative text-center">
        <div class="border border-indigo-600 p-1 w-60 mx-auto rounded-full flex items-center justify-between mb-4">
            ...
            >Explore how to use DashLive</span>
            <a href="/users" class="w-8 h-8 rounded-full flex justify-center items-center bg-indigo-600 hover:bg-indigo-700 active:bg-indigo-600">
        ...
        <p class="max-w-sm mx-auto text-center text-base font-normal leading-7 text-gray-500 mb-9">
            DashLive helps you organize, monitor, and manage user data with ease — all in a clean and responsive dashboard powered by Livewire.
        </p>
        <a href="javascript:;"
