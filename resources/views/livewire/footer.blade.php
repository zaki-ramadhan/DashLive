    ...
    <div class="mx-auto max-w-7xl px-4 lg:px-12 p-12 pb-8 rounded-2xl bg-neutral-100">
        <div class="flex flex-col min-[830px]:flex-row items-center justify-between gap-6 pb-10 border-b-2 border-gray-200">
            ...
            <ul class="flex flex-col sm:flex-row items-center gap-5 sm:gap-12">
                <li>
                    <a href="/" wire:current.exact="text-indigo-500"
                        class=" font-normal text-gray-800 transition-all duration-300 hover:text-indigo-600 focus-within:text-indigo-600 focus-within:outline-0">Home
                    </a>
                </li>
                <li>
                    <a href="/users" wire:current="text-indigo-500"
                        class=" font-normal text-gray-800 transition-all duration-300 hover:text-indigo-600 focus-within:text-indigo-600 focus-within:outline-0">Users
                    </a>
                </li>
                <li>
                    <a href="/about-us" wire:current="text-indigo-500"
                        class=" font-normal text-gray-800 transition-all duration-300 hover:text-indigo-600 focus-within:text-indigo-600 focus-within:outline-0">About
                    </a>
                </li>
                <li>
                    <a href="/contact" wire:current="text-indigo-500"
                        class=" font-normal text-gray-800 transition-all duration-300 hover:text-indigo-600 focus-within:text-indigo-600 focus-within:outline-0">Contact
                    </a>
                </li>
            </ul>
        </div>
