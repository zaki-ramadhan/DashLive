<div class="flex justify-content-center ">
            ...
            <div class="mt-4 sm:mx-auto sm:w-full sm:max-w-sm">
                ...
                <form wire:submit.prevent="createNewUser" action="#" method="POST" id="createUserForm"
                    ...
                    <div class="col-span-full">
                        ...
                        <div
                            class="mt-2 flex justify-center rounded-xl border border-dashed border-gray-900/25 px-6 py-10">
                    ...
                    <div>
                        <button
                            ...
                            wire:loading.attr="disabled" wire:loading.class="opacity-50 cursor-loading hover:translate-y-0 hover:shadow-none"
                            wire:loading.remove.class="opacity-100 cursor-pointer">
                            <span wire:loading.remove>Create new user</span>
                            <span wire:loading><span class="loading loading-spinner loading-sm mr-1"></span>
                                Saving...</span>
                        </button>
                    </div>
                </form>
    ...
    <div class="w-1/2 mx-auto py-10 pe-10">
        <h2 class="mt-10 mb-6 text-center text-2xl/9 font-bold tracking-tight text-gray-900">List of users</h2>
        <ul role="list" class="divide-y divide-gray-100">
            @foreach ($users as $user)
                <li class="flex justify-between gap-x-6 py-5">
                    <div class="flex min-w-0 gap-x-4">
                        <img src="{{ $user->avatar ?? asset('img/default-avatar.jpeg') }}"
