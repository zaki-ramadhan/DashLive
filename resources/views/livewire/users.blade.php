    ...
    <div class="px-6 lg:px-8 flex flex-col items-center justify-center">
        ...
        <div class="mt-4 sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            @if (session()->has('message'))
                <div class="relative w-full items-center max-w-7xl ">
            ...
            <form wire:submit.prevent="createNewUser" action="#" method="POST" id="createUserForm"
                ...
                <div>
                    <button
                        ...
                        <span wire:loading><span class="loading loading-spinner loading-sm mr-1"></span> Saving...</span>
                    </button>
                </div>
            </form>
    ...
    <div class="mt-20 grid grid-cols-5 grid-rows-2 gap-x-4 gap-y-6">
        @foreach ($users as $user)
            <div
                ...
                <p class="text-sm text-gray-800 group-hover:text-blue-600 line-clamp-1 hyphens-auto text-left">
                    {{ $user->name }}</p>
            </div>
        @endforeach
    </div>
